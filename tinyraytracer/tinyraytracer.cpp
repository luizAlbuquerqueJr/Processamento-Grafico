...
void render(const std::vector<Sphere> &spheres, const std::vector<Light> &lights) {
    ...
    Vec3f direct = Vec3f(1,0,-1).normalize();   //Vetor diretor da câmera
    Vec3f up = Vec3f(1,1,1).normalize();        //Vetor Y
    Vec3f eixo = Vec3f(-1,2,-1).normalize();    //Vetor X
    ...
    ofs.open("./reflexaoTCam.ppm",std::ios::binary);
    ofs << "P6\n" << width << " " << height << "\n255\n";
